# SKILL: Filling LLP_MLLP-3A-NCRA

**Form:** Statement of Resignation of Noncommercial Registered Agent (Maine Limited Liability Partnership)  
...
| `entity.name` | text | high | (Name of Limited Liability Partnership as it appears on the records of the Secretary of State) |
...
- resignation_notice.recipient_title is non-empty (any partner-level title for the LLP — General Partner, Managing Partner, Authorized Person, etc.; not restricted to corporate-officer titles). (depends on `resignation_notice.recipient_title`)
