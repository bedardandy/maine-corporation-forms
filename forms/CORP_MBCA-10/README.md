...
- `merger.fourth_election` maps to 2 widgets; all receive the same value.
- `merger.sixth_election` maps to 2 widgets; all receive the same value.
- `merger.seventh_election` maps to 2 widgets; all receive the same value.
