...
- `filing.accompanying_filing_type` maps to 6 widgets; all receive the same value.
- `entity.professional_services_description` maps to 2 widgets; all receive the same value.
- `clerk.type` maps to 2 widgets; all receive the same value.
- `clerk.name` maps to 2 widgets; all receive the same value.
- `entity.share_structure` maps to 2 widgets; all receive the same value.
- `entity.has_board_of_directors` maps to 2 widgets; all receive the same value.
