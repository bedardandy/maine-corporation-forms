...
- `clerk_change.address_change_authorized_by` binds as a single enum_text_select selecting among 2 option widgets (accepted values: town_municipality, us_postal_service).
